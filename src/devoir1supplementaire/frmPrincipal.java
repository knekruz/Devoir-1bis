...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void btnNbAnneesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNbAnneesMouseClicked
        double total = 0;
        double anneeVariable = 31;
        double an = 0;
        
        while (total <= 150)
        {
            total = total + anneeVariable;
            anneeVariable = anneeVariable * 0.8;
            
            an++;
        }
        lblNbSemaines.setText(an + " années !");
    ...
    private void btnTriangleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTriangleMouseClicked
        ...
        String agePers = txt.getText();
        int age = Integer.parseInt(agePers);
        
        DefaultTableModel dtmTriangle = (DefaultTableModel)tblTriangle.getModel();
        Vector v,x;
        v = new Vector();
        x = new Vector();
        v.add(" ");
    ...
    private void btnCalculerPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCalculerPrimeMouseClicked
        ...
        String txtNbAnnee = txtNbAnnees.getText();
        int intAncien = Integer.parseInt(txtNbAnnee);
        String txtBugs = txtNbBugs.getText();
        int intBugs = Integer.parseInt(txtBugs);
        
        double anneeAncien = intAncien;
        double nbBugs = intBugs;
        ...
        if (totalObtenu > 400){
            lblPrime.setText("Prime :" + 400 + "euros !");
        }
        else{
            if (anneeAncien > 4){
                annee = anneeAncien - 4;
            ...
            totalObtenu = nbBugs * 0.04;
            totalObtenu = prime + totalObtenu;
            lblPrime.setText("Prime :" + totalObtenu + "euros !");
        }
